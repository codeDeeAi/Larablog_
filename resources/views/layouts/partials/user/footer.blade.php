    ...
    >
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
          ...
          >
            Larablog is a free application for writers and creatives to post different articles, and blog posts.
            Larablog is built with laravel and was created by <a href="www.adeolabada.com" class="font-bold text-lg underline">Adeola Bada</a>. 
          </p>
        </div>
